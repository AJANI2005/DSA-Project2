...
//
//  Program to create a Minimum Binary Heap (MinHeap), using tree-structured
...
//------------------------------------------------------------------------
void MinHeap::heapifyUp(Node* node)
    {
...
//------------------------------------------------------------------------
Node* MinHeap::findNode(Node* node, int value)
    {
        if (node == nullptr)
            return nullptr;
...
//------------------------------------------------------------------------
void MinHeap::setParents(Node* ptr)
    {
        if (ptr == NULL)
            return;
        else
...
//------------------------------------------------------------------------
Node* MinHeap::insertHelper(Node* ptr, Node* node)
    {
        if(ptr == NULL)
            {
                ptr = node;
