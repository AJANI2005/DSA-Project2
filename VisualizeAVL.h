...
display_rows get_row_display(AVLTree *);
void Draw(AVLTree *);
vector<string> row_formatter(const display_rows &rows_disp);
int max_depth(AVLNode *);
//==============================================================
...
display_rows get_row_display(AVLTree *ptr) {
  // start off by traversing the tree to
  // build a vector of vectors of Node pointers
  vector<AVLNode *> traversal_stack;
  vector<vector<AVLNode *>> rows;

  if (!ptr->getRoot())
    return display_rows();

  AVLNode *node = ptr->getRoot();
