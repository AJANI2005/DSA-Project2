...
#ifndef VisualizeRBTree_h
#define VisualizeRBTree_h
#include "RBTree.h"
#include <algorithm>
#include <iostream>
#include <sstream>
...
display_rows get_row_display(RBTree *);
void Draw(RBTree *);
...
display_rows get_row_display(RBTree *ptr) {
  // start off by traversing the tree to
  // build a vector of vectors of Node pointers
  vector<RBTNode *> traversal_stack;
  vector<vector<RBTNode *>> rows;

  if (!ptr->getRoot())
    return display_rows();

  RBTNode *node = ptr->getRoot();
